# The project uses the PostgreSQL dialect and utilizes data from the following Netflix tables:
...
FROM "netflix_titles_info" people
JOIN "netflix_titles_info" titles
	ON people.show_id = titles.show_id
WHERE titles.title = 'The Staring'
